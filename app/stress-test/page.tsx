      ...
      <section className="onboarding-wrap">
        <div className="audit-sales-card">
          ...
          <section className="audit-sales-proof">
            <article>
              <p className="app-kicker">WHAT THIS DOES</p>
              <h2>Find the sentences carrying risk.</h2>
              <p className="app-copy">The preflight looks for concrete assertions with signals such as quantities, dates, company or product facts, research claims, certifications, and time-sensitive language. It helps reduce a long document to the claims most worth investigating.</p>
            </article>
            <article>
              <p className="app-kicker">WHAT THIS DOES NOT DO</p>
              <h2>It does not call a claim true.</h2>
              <p className="app-copy">Candidate ranking is not verification. ProofTTL does not issue SUPPORTED, CONTRADICTED, or UNKNOWN until the claim has been checked against evidence within a defined scope.</p>
            </article>
          </section>
          ...
          <section className="audit-preflight-standard">
            ...
            <div className="audit-sales-actions" style={{ marginTop: 18 }}>
              ...
              <a className="text-link" href="/how-proofttl-works/">See how ProofTTL works →</a>
            </div>
          </section>
