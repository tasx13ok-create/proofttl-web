...
export default function ServicesPage() {
  const structuredData = {
    '@context': 'https://schema.org', '@type': 'ItemList', name: 'ProofTTL claim verification and fact-checking services',
    itemListElement: SERVICE_INTENTS.map((intent, index) => ({ '@type': 'ListItem', position: index + 1, url: `https://proofttl-web.vercel.app/services/${intent.slug}/`, name: intent.title.replace(' | ProofTTL', '') })),
  }
