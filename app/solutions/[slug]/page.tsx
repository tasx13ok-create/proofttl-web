  ...
  return (
    <main className={styles.page}>
      ...
      <section className={`${styles.shell} ${styles.hero}`}>
        ...
        <aside className={styles.card} aria-label="ProofTTL Fact Audit scope">
          <span className={styles.cardLabel}>FACT AUDIT</span>
          <code>{`$1,500 fixed scope\n10–25 outputs or claims\nconsequence ranking\nhighest-risk deep verification\nevidence FOR and AGAINST\nhuman approval\n7-day watch`}</code>
        </aside>
      </section>
      ...
      <section className={`${styles.shell} ${styles.mainGrid}`}>
        ...
        <article className={styles.panel}>
          <h2>What the Fact Audit adds</h2>
          <ul>
        ...
        <div className={styles.cta}>
          <div>
            ...
            <p>No card is required for intake. ProofTTL confirms the scope before creating the exact $1,500 payment request.</p>
          </div>
        ...
        <section className={styles.related} aria-labelledby="related-solutions-heading">
          <div className={styles.relatedHeading}>
            <div>
              <p className={styles.eyebrow}>RELATED USE CASES</p>
              <h2 id="related-solutions-heading">More places teams use the Fact Audit.</h2>
            </div>
      ...
      <footer className={`${styles.shell} ${styles.footer}`}>
        ProofTTL · $1,500 Fact Audit · human-approved findings · seven-day watch
      </footer>
    </main>
  )
}
