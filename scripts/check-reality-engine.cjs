...
const files=[
  'public/reality-engine/ontology-engine-v2.js','public/reality-engine/ontology-engine-v3.js','public/reality-engine/ontology-engine-v4.js','public/reality-engine/ontology-engine-v5.js','public/reality-engine/ontology-engine-v6.js','public/reality-engine/ontology-engine-v7b.js','public/reality-engine/ontology-engine-v8.js','public/reality-engine/ontology-engine-v9.js','public/reality-engine/ontology-engine-v10.js','public/reality-engine/ontology-engine-v11.js','public/reality-engine/ontology-engine-v12.js','public/reality-engine/ontology-engine-v13.js','public/reality-engine/ontology-engine-v14.js','public/reality-engine/ontology-engine-v15.js'
]
...
const E=ctx.OntologyEngineV15
if(!E)throw new Error('OntologyEngineV15 did not boot')
if(E.VERSION!=='1.6.0-alpha')throw new Error(`Unexpected Reality Engine version: ${E.VERSION}`)
...
if(!E.__v14||E.__v14.WINDOW!==32||E.__v14.MIN_EVIDENCE!==12)throw new Error('Barrier Engine contract missing')
