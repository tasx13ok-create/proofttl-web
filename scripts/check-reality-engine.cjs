...
for(const required of ["OntologyEngineV21","schema:'reality-cloud-lab-v1'","methodCourtState","refusing silent reset","unreadable/corrupt","REALITY_LAB_CYCLES"])if(!labRunner.includes(required))throw new Error(`Reality Engine cloud lab runner contract missing: ${required}`)
