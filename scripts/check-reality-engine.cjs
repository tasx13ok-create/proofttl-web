...
const E=ctx.OntologyEngineV9
if(!E)throw new Error('OntologyEngineV9 did not boot')
if(E.VERSION!=='1.0.0-alpha')throw new Error(`Unexpected Reality Engine version: ${E.VERSION}`)
