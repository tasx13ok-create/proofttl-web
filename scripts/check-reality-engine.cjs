...
const files=[
  ...
  'public/reality-engine/ontology-engine-v12.js',
  'public/reality-engine/ontology-engine-v13.js',
  'public/reality-engine/ontology-engine-v14.js'
]
...
const E=ctx.OntologyEngineV14
if(!E)throw new Error('OntologyEngineV14 did not boot')
if(E.VERSION!=='1.5.0-alpha')throw new Error(`Unexpected Reality Engine version: ${E.VERSION}`)
const tests=E.selfTest(),failed=tests.filter(t=>!t.pass)
