...
const E=ctx.OntologyEngineV13
if(!E)throw new Error('OntologyEngineV13 did not boot')
if(E.VERSION!=='1.4.0-alpha')throw new Error(`Unexpected Reality Engine version: ${E.VERSION}`)
