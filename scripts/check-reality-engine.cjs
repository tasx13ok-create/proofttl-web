...
const E=ctx.OntologyEngineV12
if(!E)throw new Error('OntologyEngineV12 did not boot')
if(E.VERSION!=='1.3.0-alpha')throw new Error(`Unexpected Reality Engine version: ${E.VERSION}`)
