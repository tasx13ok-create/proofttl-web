...
export default function LocalCinematicPreview({ prompt }: { prompt: string }) {
  ...
  return (
    <section className="cine-local-movie" data-local-cinematic="true" data-cinematic-schema="proofttl-cinematic-v2">
      ...
      <small>Real-time humanoid cast, staged environment, discrete director shots, choreography, impact reactions, scrubbing, and local WebM export. No paid provider required.</small>
    </section>
  )
}
