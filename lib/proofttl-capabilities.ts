...
export const PROOFTTL_CAPABILITIES: ProofTTLCapability[] = [
  { id: 'love-command', area: 'love', label: 'Universal command', description: 'Ask L.O.V.E. what you want done instead of deciding which app to open first.', risk: 'read', state: 'live', examples: ['Explain this', 'Open Studio', 'Show my audit status'] },
  ...
  { id: 'money-intelligence', area: 'money', label: 'Money intelligence', description: 'Understand balances, spending, bills, cash flow and goals after a financial-data provider is connected.', risk: 'read', state: 'planned', examples: ['Why did I spend more?', 'Can I afford this next month?'] },
  { id: 'money-movement', area: 'money', label: 'Money movement', description: 'Future sponsor-bank or payments integrations for transfers, savings rules and bill actions.', risk: 'sensitive', state: 'planned', examples: ['Move $75 to savings', 'Pay this bill'] },
  { id: 'work-mail', area: 'work', label: 'Email', description: 'Read, search, draft and eventually send through connected mail providers.', risk: 'sensitive', state: 'planned', examples: ['Find the email from John', 'Draft a reply'] },
  { id: 'work-calendar', area: 'work', label: 'Calendar', description: 'Read schedule, find free time and create or update events with confirmation.', risk: 'modify', state: 'planned', examples: ['What meetings do I have?', 'Schedule this tomorrow'] },
  { id: 'files-library', area: 'files', label: 'Files', description: 'One account-scoped library for generated, uploaded and connected files.', risk: 'modify', state: 'planned', examples: ['Find my resume', 'Open the report'] },
  { id: 'automations', area: 'automations', label: 'Automations', description: 'Recurring and condition-based actions using only connected capabilities and explicit permissions.', risk: 'sensitive', state: 'planned', examples: ['Every Friday summarize my week', 'When X happens do Y'] },
  { id: 'connections', area: 'connections', label: 'Connections', description: 'Central permissioned integrations for identity, AI models, developer tools, work apps and future financial providers.', risk: 'sensitive', state: 'built_locked', examples: ['Connect Google', 'Connect GitHub', 'Choose an AI model'] },
